...
void main( void ) {
	...
	color3.r =  ((color3.r) * (color3.r/color2.r) * combinedPosition );

	color3.g =  ((color3.g) * (color3.g/color2.g) * combinedPosition );

	color3.b =  ((color3.b) * (color3.b/color2.b) * combinedPosition );
